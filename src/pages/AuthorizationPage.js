...
export const AuthorizationPage = () => {
    ...
    const loginHandler = async () => {
        try {
            const data = await request("https://anamnesis-vitae.herokuapp.com/api/auth/login", "POST", { ...input });
    ...
    const registerHandler = async () => {
        try {
            const data = await request("https://anamnesis-vitae.herokuapp.com/api/auth/register", "POST", { ...input });
