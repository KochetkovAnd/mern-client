...
const auth = useContext(AuthContext)
    ...
    try {
        const patients = await request(
            "https://anamnesis-vitae.herokuapp.com/api/auth/patients",
            "POST",
            {},
            ...
            return (
                <div className="content-box-create-page">
                    <ul className="navbar-vitae">
                        ...
                        <li><a href = "https://app-flask-vitae.herokuapp.com/" className="navbar-vitae-a-white-active">Статистика</a></li>
                        <li><LogoutText/></li>
                    </ul>
